...
function formatAvatarDecoding(
  ...
  const lines = `
ЧТО ТЫ ПОЛУЧИШЬ ПОСЛЕ ВВОДА ДАТЫ
После расчёта ты увидишь ключевые точки твоих Аватаров, которые сильнее всего влияют на жизнь здесь и сейчас:
 
 Характер:
Какой ты человек по своей природе.
Как ты думаешь, реагируешь, принимаешь решения.
Почему одни вещи даются легко, а другие вызывают сопротивление.
 
⸻
Зона комфорта: 
Где тебе спокойно и безопасно.
Почему иногда тянет «остаться в привычном», даже если хочется большего.
И как выходить из зоны комфорта без стресса и ломки.
⸻
 
Таланты:
Твои врождённые способности и сильные стороны.
То, через что ты можешь реализовываться, быть полезным и востребованным.
Часто именно эти таланты мы обесцениваем — а зря.
⸻
 
Деньги:
Как у тебя выстроены отношения с деньгами.
Через что приходит доход, а где возникают блоки.
Почему усилия не всегда равны результату — и что с этим делать.
⸻
 
Уроки в падении:
Главные жизненные уроки, которые повторяются, если их не осознать.
Те самые ситуации, где «кажется, я снова в этом».
Понимание этих уроков помогает перестать ходить по кругу.
 
⸻
ВАЖНО ЗНАТЬ
Этот бот даёт базовое понимание твоих Аватаров, твоей сути, чтобы ты:
...
 
👉 Это не вся система, а её ключевая часть.
Глубинные причины, прогнозы, периоды, отношения и персональный план действий
разбираются на консультациях.`
